...
namespace Com_Methods
{
    ...
    public class Matrix : IMatrix
    {
        ...
        public Matrix(string PATH, double Perturbation = 1.0)
        {
                ...
                try
                {
                    ...
                    for (int i = 0; i < M; i++) {
                        ...
                        for (int j = 0; j < N; j++)
                        {
                            ...
                            if (i == j) Elem[i][j] *= Perturbation;
                        }
                    }
                }
                catch
                {
                    throw new Exception("Matrix: Incorrect data file");
                }
            }
        }
